...
#define LOCTEXT_NAMESPACE "VDComponentCustomization"

#define RowWidth_Customization 50

////////////////////////////////////////////////////////////////
FVDComponentCustomization::FVDComponentCustomization()
{
...
void FVDComponentCustomization::RefreshCollisionProfiles()
{
...
void FVDComponentCustomization::CustomizeChildren(TSharedRef<class IPropertyHandle> StructPropertyHandle, class IDetailChildrenBuilder& StructBuilder, IPropertyTypeCustomizationUtils& StructCustomizationUtils)
{
	...
	CollisionResponsesHandle = StructPropertyHandle->GetChildHandle(TEXT("CollisionResponse"));

	check(CollisionProfileNameHandle.IsValid());
	check(CollisionEnabledHandle.IsValid());
	check(ObjectTypeHandle.IsValid());

	// copy all CollisionSettings I'm accessing right now
	TArray<void*> StructPtrs;
	StructPropertyHandle->AccessRawData(StructPtrs);
	check(StructPtrs.Num() != 0);

	CollisionSettings.AddUninitialized(StructPtrs.Num());
	for (auto Iter = StructPtrs.CreateIterator(); Iter; ++Iter)
	{
		check(*Iter);
		CollisionSettings[Iter.GetIndex()] = (FVDCollisionSettings*) (*Iter);
	}
	...
	if (CollisionProfileNameHandle->GetValue(ProfileName) == FPropertyAccess::Result::Success && (ProfileName != NAME_None) && (ProfileName != UCollisionProfile::CustomCollisionProfileName))
	{
	...
	.ValueContent()
		[
			...
			[
				...
				.OnGenerateWidget(this, &FVDComponentCustomization::MakeCollisionProfileComboWidget)
				.OnSelectionChanged(this, &FVDComponentCustomization::OnCollisionProfileChanged, &CollisionGroup)
				.OnComboBoxOpening(this, &FVDComponentCustomization::OnCollisionProfileComboOpening)
				...
				[
					SNew(STextBlock)
					.Text(this, &FVDComponentCustomization::GetCollisionProfileComboBoxContent)
					.Font(IDetailLayoutBuilder::GetDetailFont())
					.ToolTipText(this, &FVDComponentCustomization::GetCollisionProfileComboBoxToolTip)
				]
			]
			+ SHorizontalBox::Slot()
				.VAlign(VAlign_Center)
				...
				[
					SNew(SButton)
					.OnClicked(this, &FVDComponentCustomization::SetToDefaultProfile)
					.Visibility(this, &FVDComponentCustomization::ShouldShowResetToDefaultProfile)
					.ContentPadding(0.f)
...
int32 FVDComponentCustomization::InitializeObjectTypeComboList()
{
...
TSharedPtr<FString> FVDComponentCustomization::GetProfileString(FName ProfileName) const
{
...
void FVDComponentCustomization::UpdateValidCollisionChannels()
{
	// find the enum
	UEnum * Enum = FindObject<UEnum>(ANY_PACKAGE, TEXT("ECollisionChannel"), true);
	// we need this Enum
...
BEGIN_SLATE_FUNCTION_BUILD_OPTIMIZATION
void FVDComponentCustomization::CreateCustomCollisionSetup(TSharedRef<class IPropertyHandle> StructPropertyHandle, class IDetailGroup& CollisionGroup)
{
	...
	TAttribute<bool> CustomCollisionEnabled(this, &FVDComponentCustomization::ShouldEnableCustomCollisionSetup);
	TAttribute<EVisibility> CustomCollisionVisibility(this, &FVDComponentCustomization::ShouldShowCustomCollisionSetup);
	...
	if (!StructPropertyHandle->GetProperty()->GetBoolMetaData(TEXT("HideObjectType")))
	{
		...
		.ValueContent()
			[
				...
				.OnGenerateWidget(this, &FVDComponentCustomization::MakeObjectTypeComboWidget)
				.OnSelectionChanged(this, &FVDComponentCustomization::OnObjectTypeChanged)
				...
				[
					SNew(STextBlock)
					.Text(this, &FVDComponentCustomization::GetObjectTypeComboBoxContent)
					.Font(IDetailLayoutBuilder::GetDetailFont())
				]
			];
	}
	...
	.ValueContent()
		[
			...
			[
				...
				[
					SNew(SCheckBox)
					.OnCheckStateChanged(this, &FVDComponentCustomization::OnAllCollisionChannelChanged, ECR_Ignore)
					.IsChecked(this, &FVDComponentCustomization::IsAllCollisionChannelChecked, ECR_Ignore)
				]
			]
			...
			+ SHorizontalBox::Slot()
				...
				[
					...
					[
						SNew(SCheckBox)
						.OnCheckStateChanged(this, &FVDComponentCustomization::OnAllCollisionChannelChanged, ECR_Overlap)
						.IsChecked(this, &FVDComponentCustomization::IsAllCollisionChannelChecked, ECR_Overlap)
					]
				]
			...
			+ SHorizontalBox::Slot()
				...
				[
					...
					[
						SNew(SCheckBox)
						.OnCheckStateChanged(this, &FVDComponentCustomization::OnAllCollisionChannelChanged, ECR_Block)
						.IsChecked(this, &FVDComponentCustomization::IsAllCollisionChannelChecked, ECR_Block)
					]
				]
		];
			...
			.ValueContent()
				[
					...
					[
						...
						[
							SNew(SCheckBox)
							.OnCheckStateChanged(this, &FVDComponentCustomization::OnCollisionChannelChanged, Index, ECR_Ignore)
							.IsChecked(this, &FVDComponentCustomization::IsCollisionChannelChecked, Index, ECR_Ignore)
						]
					]
					+ SHorizontalBox::Slot()
						.AutoWidth()
						...
						[
							...
							[
								SNew(SCheckBox)
								.OnCheckStateChanged(this, &FVDComponentCustomization::OnCollisionChannelChanged, Index, ECR_Overlap)
								.IsChecked(this, &FVDComponentCustomization::IsCollisionChannelChecked, Index, ECR_Overlap)
							]
					...
					+ SHorizontalBox::Slot()
						...
						[
							SNew(SCheckBox)
							.OnCheckStateChanged(this, &FVDComponentCustomization::OnCollisionChannelChanged, Index, ECR_Block)
							.IsChecked(this, &FVDComponentCustomization::IsCollisionChannelChecked, Index, ECR_Block)
						]
					...
					+ SHorizontalBox::Slot()
						...
						[
							SNew(SButton)
							.OnClicked(this, &FVDComponentCustomization::SetToDefaultResponse, Index)
							.Visibility(this, &FVDComponentCustomization::ShouldShowResetToDefaultResponse, Index)
							.ContentPadding(0.f)
							.ToolTipText(LOCTEXT("ResetToDefaultToolTip", "Reset to Default"))
							.ButtonStyle(FEditorStyle::Get(), "NoBorder")
							.Content()
...
TSharedRef<SWidget> FVDComponentCustomization::MakeObjectTypeComboWidget(TSharedPtr<FString> InItem)
{
	return SNew(STextBlock).Text(FText::FromString(*InItem)).Font(IDetailLayoutBuilder::GetDetailFont());
}

void FVDComponentCustomization::OnObjectTypeChanged(TSharedPtr<FString> NewSelection, ESelectInfo::Type SelectInfo)
{
...
FText FVDComponentCustomization::GetObjectTypeComboBoxContent() const
{
...
TSharedRef<SWidget> FVDComponentCustomization::MakeCollisionProfileComboWidget(TSharedPtr<FString> InItem)
{
...
void FVDComponentCustomization::OnCollisionProfileComboOpening()
{
	FName ProfileName;
...
void FVDComponentCustomization::OnCollisionProfileChanged(TSharedPtr<FString> NewSelection, ESelectInfo::Type SelectInfo, IDetailGroup* CollisionGroup)
{
	// if it's set from code, we did that on purpose
	if (SelectInfo != ESelectInfo::Direct)
	{
...
void FVDComponentCustomization::UpdateCollisionProfile()
{
	FName ProfileName;
...
FReply FVDComponentCustomization::SetToDefaultProfile()
{
...
EVisibility FVDComponentCustomization::ShouldShowResetToDefaultProfile() const
{
...
FReply FVDComponentCustomization::SetToDefaultResponse(int32 ValidIndex)
{
...
EVisibility FVDComponentCustomization::ShouldShowResetToDefaultResponse(int32 ValidIndex) const
{
	if (ValidCollisionChannels.IsValidIndex(ValidIndex))
	{
		const ECollisionResponse DefaultResponse = FCollisionResponseContainer::GetDefaultResponseContainer().GetResponse(ValidCollisionChannels[ValidIndex].CollisionChannel);
...
bool FVDComponentCustomization::ShouldEnableCustomCollisionSetup() const
{
	FName ProfileName;
	if (CollisionProfileNameHandle->GetValue(ProfileName) == FPropertyAccess::Result::Success && !((ProfileName != NAME_None) && (ProfileName != UCollisionProfile::CustomCollisionProfileName)))
	{
...
EVisibility FVDComponentCustomization::ShouldShowCustomCollisionSetup() const
{
	return EVisibility::Visible;//return (bDisplayAdvancedCollisionSettings)? EVisibility::Visible : EVisibility::Hidden;
}

FText FVDComponentCustomization::GetCollisionProfileComboBoxContent() const
{
	FName ProfileName;
	if (CollisionProfileNameHandle->GetValue(ProfileName) == FPropertyAccess::Result::MultipleValues)
	{
...
FText FVDComponentCustomization::GetCollisionProfileComboBoxToolTip() const
{
	FName ProfileName;
...
void FVDComponentCustomization::OnCollisionChannelChanged(ECheckBoxState InNewValue, int32 ValidIndex, ECollisionResponse InCollisionResponse)
{
	if (ValidCollisionChannels.IsValidIndex(ValidIndex))
	{
...
void FVDComponentCustomization::SetResponse(int32 ValidIndex, ECollisionResponse InCollisionResponse)
{
	...
	for (auto Iter = CollisionSettings.CreateIterator(); Iter; ++Iter)
	{
		FVDCollisionSettings* CollisionSetting = *Iter;

		CollisionSetting->CollisionResponse.SetResponse(ValidCollisionChannels[ValidIndex].CollisionChannel, InCollisionResponse);
	}

	CollisionResponsesHandle->NotifyPostChange();
}

ECheckBoxState FVDComponentCustomization::IsCollisionChannelChecked(int32 ValidIndex, ECollisionResponse InCollisionResponse) const
{
	TArray<uint8> CollisionResponses;

	if (ValidCollisionChannels.IsValidIndex(ValidIndex))
	{
		for (auto Iter = CollisionSettings.CreateConstIterator(); Iter; ++Iter)
		{
			FVDCollisionSettings* CollisionSetting = *Iter;

			CollisionResponses.AddUnique(CollisionSetting->CollisionResponse.GetResponse(ValidCollisionChannels[ValidIndex].CollisionChannel));
		}
...
void FVDComponentCustomization::OnAllCollisionChannelChanged(ECheckBoxState InNewValue, ECollisionResponse InCollisionResponse)
{
...
ECheckBoxState FVDComponentCustomization::IsAllCollisionChannelChecked(ECollisionResponse InCollisionResponse) const
{
...
void FVDComponentCustomization::SetCollisionResponseContainer(const FCollisionResponseContainer& ResponseContainer)
{
	// trigger transaction before UpdateCollisionProfile
	...
	for (uint32 Index = 0; Index < TotalNumChildren; ++Index)
	{
		...
		// iterate through CollisionSettings and fix it
		for (FVDCollisionSettings* CollisionSetting : CollisionSettings)
		{
			CollisionSetting->CollisionResponse.SetResponse(Channel, Response);
		}
	}
